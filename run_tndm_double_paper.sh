...
echo "Running TNDM on dataset: $DATASET"

DATA_DIR=exp_data/$DATASET
DATA_STEM=data_0.h5
...
independence_weight=1000.0
num_independence_batchs=10
...
do
    ...
    RESULTS_DIR=final_results_$DATASET/$DATA_STEM/tndm_double/$results_path
